...
label day1:
    ...
    gg "Я молодец!!! Сколько время? 10:26...\nНууу в моем плане нет точного времени, когда начать, да и я люблю точность, так что могу отдохнуть ровно до 11, а потом начну"
